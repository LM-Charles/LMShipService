...
public class FedexTrackingResponseParser implements TrackingResponseParser {
    ...
    public ShipmentTrackingResponse parseResponse(JsonNode jsonNode) throws DependentServiceException {
        ...
        String trackingCity = jsonNode.path("/TrackReply/TrackDetails/Events/0/Address/City").asText();
        String trackingCountry = jsonNode.path("/TrackReply/TrackDetails/Events/0/Address/CountryCode").asText();
