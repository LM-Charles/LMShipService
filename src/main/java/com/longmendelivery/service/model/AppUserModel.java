...
public class AppUserModel implements Model {
    ...
    public AppUserModel(String phone, String email, String password_md5, AppUserGroupEntity userGroup, AppUserStatusEntity userStatus) {
        this.phone = phone;
        this.email = email;
    ...
    public AppUserModel(Integer id, String phone, String email, String password_md5, AppUserGroupEntity userGroup, AppUserStatusEntity userStatus, String apiToken, String verificationString, String firstName, String lastName, String address, String city, String province, String country, Set<OrderEntity> orders) {
        this.id = id;
        this.phone = phone;
        this.email = email;
        this.password_md5 = password_md5;
    ...
    public boolean equals(Object o) {
        ...
        AppUserModel appUser = (AppUserModel) o;
