...
render()
{
    ...
    return (
        < div
    className = "component-EditorWithState-container" >
        < h3 > LM
    Administrative
    Website < / h3 >
    < Row >
    ...
    buttonAfter = {queryShipmentButton}
    /></
    Col >
    < / Row >
    < Row >
    ...
    md = "12" >
        < Panel
    collapsible
    header = "&#9654; Order Details for #11241498" >
        < textarea
    rows = "20" >
        {mockOrder}
        < / textarea >
    ...
    md = "4" > < Input
    type = 'text'
    placeholder = 'Length' / > < / Col >
        < Col
    md = "4" > < Input
    type = 'text'
    placeholder = 'Width' / > < / Col >
        < Col
    md = "4" > < Input
    type = 'text'
    placeholder = 'Height' / > < / Col >
        < / Row >
        < Row >
        < Col
    md = "12" >
    ...
    md = "12" >
        ...
        < Col
    md = "2" > < Button
    className = "fill" > Re - calculate
    Rate... < /Button></
    Col >
    < Col
    md = "2" > < Button
    className = "fill"
    onClick = {this.openUpdateOrderStatus
}
>
Update
Status... < /Button></
...
< / Row >
< Modal
show = {this.state.showUpdateOrderStatus
}
onHide = {this.closeUpdateOrderStatus
}>
<
Modal.Header
closeButton >
...
Transit < / option >
< option
value = 'EXCEPTION' > Exception < / option >
    < option
...
placeholder = 'Describe your change' / >
    ...
    < Col
md = "6" > < Button
onClick = {this.closeUpdateOrderStatus
}>
Close < /Button></
Col >
< Col
md = "6" > < Button
bsStyle = "primary"
onClick = {this.updateOrderStatusConfirm
}>
Save < /Button></
Col >
< / Row >
